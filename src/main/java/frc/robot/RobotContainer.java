...
public class RobotContainer {
    ...
    public final PoseEstimator m_poseEstimator = new PoseEstimator(m_camera, m_drivetrain);
...
public void configureButtonBindings() {
    ...
    tagAlignBtn.toggleOnTrue(new TagAlign(m_camera, m_drivetrain, m_poseEstimator));
}
